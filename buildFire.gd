...
# Textures
var tinderTexture: Texture = load("res://Assets/Wood_Sprites/wood_9.png")
var kindlingTexture: Texture = load("res://Assets/Wood_Sprites/wood_3.png")
var fuelTexture: Texture = load("res://Assets/Wood_Sprites/wood_4.png")

# Arrays
var countArr: Array[int] = [TINDER, KINDLING, FUEL]
var strArr: Array[String] = ["Tinder", "Kindling", "Fuel"]
var textureArr: Array[Texture] = [tinderTexture, kindlingTexture, fuelTexture]
